...
$sql = "SELECT BRAND, DI_DAY,
    ...
    WHERE DI_YEAR = :DI_YEAR AND DI_MONTH = :DI_MONTH AND SKU_CAT LIKE :SKU_CAT AND SALE_NAME LIKE :SALE_NAME
...
<div class="card">
    ...
    <div class="card-body">
        ...
        <div class="table-responsive">
            <h5 class="mb-3">ข้อมูลยอดขายรายวันตามยี่ห้อ ตามประเภท <?php echo $sku_cat . " " . $month_name . ' ปี ' . $year . " Sale " . $sale_name ; ?></h5>
...
<script>
    ...
    const provinces = <?php echo json_encode($brands); ?>;
    ...
    const titleText = `ยอดขาย ${sku_cat} รายยี่ห้อในเดือน ${monthName} ปี ${year} สำหรับ ${saleName}`;
