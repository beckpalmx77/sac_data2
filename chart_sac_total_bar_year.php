...
<head>
    ...
    <style>
        ...
        .scroll-buttons {
            margin-bottom: 10px; /* เพิ่มพื้นที่ระหว่างปุ่มและตาราง */
        }

        table {
            min-width: 600px; /* กำหนดขนาดตารางที่ใหญ่กว่าขนาดของ div เพื่อให้ scrollbar ปรากฏ */
        }
    </style>
