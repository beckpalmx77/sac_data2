...
$sql_sqlsvr = "SELECT DOCINFO.DI_KEY,DOCINFO.DI_REF,DOCINFO.DI_ACTIVE FROM DOCINFO WHERE DOCINFO.DI_REF.DI_ACTIVE = 1";
...
while ($result_sqlsvr = $stmt_sqlsvr->fetch(PDO::FETCH_ASSOC)) {
    ...
    $sql_delete = "DELETE FROM ims_product_sale_sac 
                WHERE DI_KEY = :DI_KEY  AND DI_REF  = :DI_RE";
    ...
    $delete_data .= $result_sqlsvr["DI_KEY"] . ":" . $result_sqlsvr["DI_REF"] . " |- "  . "\n\r";
