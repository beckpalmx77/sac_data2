...
if (strlen($_SESSION['alogin']) == "") {
                                        ...
                                        <form id="export_data" method="post"
                                            ...
                                            <div class="col-md-12 col-md-offset-2"
                                                ...
                                                <button type="button" name="btnFilter" id="btnFilter"
                                                        class="btn btn-primary btn-xs" onclick="FilterData();">
    ...
    <script>
        $(document).ready(function () {
            ...
            let formData = {action: "GET_STOCK_BALANCE", sub_action: "GET_MASTER" ,doc_date_start: doc_date_start ,doc_date_to: doc_date_to};
