...
if (isset($_FILES['excelFile']['name']) && $_FILES['excelFile']['error'] == UPLOAD_ERR_OK) {
    ...
    try {
        ...
        foreach ($rows as $index => $row) {
            ...
            $TRD_TOTALPOINT = empty($row[19]) || $row[19] === null || $row[19] === "" ? "0" : str_replace(",", "", $row[19]);
            ...
            if ($DI_DAY !== "-" && $DI_MONTH !== "-" && $DI_YEAR !== "-" && $DI_REF !== "-" && $AR_CODE !== "-" && $SKU_CODE !== "-") {
                ...
                if ((int)$statement->fetchColumn() === 0) {
                    ...
                    $stmt_insert->execute([
                        ...
                        , $TRD_DISCOUNT, $TRD_TOTAL_PRICE, $TRD_VAT, $TRD_AMOUNT_PRICE, $TRD_PER_POINT, $TRD_TOTALPOINT, $WL_CODE, $TRD_Q_FREE, $TRD_AMPHUR
