...
if (isset($_FILES['excelFile']['name']) && $_FILES['excelFile']['error'] == UPLOAD_ERR_OK) {
    ...
    try {
        ...
        foreach ($rows as $index => $row) {
            ...
            $TRD_PER_POINT = ($data[18] === "" || $data[18] === null ? "0" : $data[18]);
            $TRD_TOTAL_POINT = ($data[19] === "" || $data[19] === null ? "0" : $data[19]);
            $WL_CODE = ($data[20] === "0" ? "-" : $data[20]);
            $TRD_Q_FREE = $data[21];
            $TRD_AMPHUR = ($data[22] === "0" ? "-" : $data[22]);
            $TRD_PROVINCE = ($data[23] === "0" ? "-" : $data[23]);
            $TRD_MARK = ($data[24] === "0" ? "-" : $data[24]);
            $TRD_U_POINT = ($data[25] === "" || $data[25] === null ? "0" : $data[25]);
            $TRD_R_POINT = ($data[26] === "" || $data[26] === null ? "0" : $data[26]);
            $TRD_S_POINT = ($data[27] === "" || $data[27] === null ? "0" : $data[27]);
            $TRD_T_POINT = ($data[28] === "" || $data[28] === null ? "0" : $data[28]);
