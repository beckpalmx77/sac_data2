                                    ...
                                    <section class="container-fluid">
                                        ...
                                        <div class="col-md-12 col-md-offset-2">
                                            <table id='TableRecordList' class='display dataTable'>
                                                <thead>
                                                <tr>
                                                    <th>รหัสตำแหน่งคลังสินค้า</th>
                                                    <th>ตำแหน่งคลังสินค้า</th>
                                                    <th>Status</th>
                                                    <th>Action</th>
                                                    <th>Action</th>
                                                </tr>
                                                    ...
                                                    <form method="post" id="recordForm">
                                                        <div class="modal-body">
                                                            <div class="modal-body">
                                                                ...
                                                                <div class="form-group">
                                                                    <label for="name_t"
                                                                           class="control-label">ตำแหน่งคลังสินค้า</label>
                                                                    <input type="text" class="form-control"
                                                                           id="location_group"
                                                                           name="location_group"
                                                                           required="required"
                                                                           placeholder="ตำแหน่งคลังสินค้า">
                                                                </div>
    ...
    <script>
        ...
        $("#location_group").blur(function () {
            ...
            if (method === "ADD") {
                ...
                $.ajax({
                    url: 'model/manage_wh_location_process.php',
                    method: "POST",
                    data: formData,
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    for (let i = 0; i < len; i++) {
                        ...
                        let location_group = response[i].location_group;
                        let status = response[i].status;

                        $('#recordModal').modal('show');
                        $('#id').val(id);
                        $('#location_id').val(location_id);
                        $('#location_group').val(location_group);
                        $('#status').val(status);
