...
if (strlen($_SESSION['alogin']) == "") {
                                                        ...
                                                        <div class="modal-body">
                                                            <div class="modal-body">
                                                                ...
                                                                <div class="form-group">
                                                                    <label for="location_id" class="control-label">รหัสจุดหมาย</label>
                                                                ...
                                                                <div class="form-group">
                                                                    <label for="name_t"
                                                                           class="control-label">จุดหมาย</label>
    ...
    <script>
        $(document).ready(function () {
            let formData = {action: "GET_LOCATION_OUT", sub_action: "GET_MASTER"};
