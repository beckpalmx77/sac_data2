...
<head>
    ...
    <title>Data Fetch with DataTables</title>
...
<div class="container-fluid mt-4">
    <h2 class="text-center">ค้นหาข้อมูลการขาย</h2>
    ...
    <!-- พื้นที่แสดงผล -->
    <div id="result" class="table-wrapper mt-4"></div>
</div>
        ...
        $('#filterForm').on('submit', function(e){
            ...
            $.ajax({
                ...
                success: function(response){
                    ...
                    // ใช้ DataTables กับตาราง
                    $('#salesTable').DataTable({
                        "paging": true,    // เปิดการแบ่งหน้า
                        "searching": true, // เปิดการค้นหา
                        "ordering": true,  // เปิดการจัดเรียงคอลัมน์
                        "info": true,      // แสดงข้อมูลการแบ่งหน้า
                        "lengthChange": true // เปิดการเลือกจำนวนแถวที่แสดง
                    });
                }
            });
        });
