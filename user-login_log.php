...
if (strlen($_SESSION['alogin']) == "") {
                                                            ...
                                                            <div class="modal-body">
                                                                ...
                                                                <div class="form-group">
                                                                    <label for="ip_address"
                                                                           class="control-label">ip_address</label>
    ...
    <script>
        ...
        $("#login_timestamp").blur(function () {
            let method = $('#action').val();
            if (method === "ADD") {
                let user_id = $('#user_id').val();
                let login_timestamp = $('#login_timestamp').val();
                let formData = {action: "SEARCH", user_id: user_id, login_timestamp: login_timestamp};
                $.ajax({
    ...
    <script>
        $(document).ready(function () {
            let formData = {action: "GET_LOGIN_LOG", sub_action: "GET_MASTER"};
            let dataRecords = $('#TableRecordList').DataTable({
                ...
                'serverMethod': 'post',
                'ajax': {
                    'url': 'model/manage_user-login-log_process.php',
                    'data': formData
                },
                'columns': [
                    {data: 'user_id'},
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    for (let i = 0; i < len; i++) {
                        ...
                        let login_timestamp = response[i].login_timestamp;
                        let ip_address = response[i].ip_address;

                        $('#recordModal').modal('show');
                        $('#id').val(id);
                        $('#user_id').val(user_id);
                        $('#login_timestamp').val(login_timestamp);
